              ...
              <div className="flex-1">
                ...
                {/* <div className="flex items-center justify-center p-4 mt-6">
                  <a
                    ...
                    href="#"
                  >
                    <span className="material-symbols-outlined text-[#111813] text-xl">
                      chevron_left
                    </span>
                  </a>
                  <a
                    className="text-sm font-bold leading-normal tracking-[0.015em] flex size-10 items-center justify-center text-black rounded-full bg-primary"
                    href="#"
                  >
                    1
                  </a>
                  <a
                    className="text-sm font-normal leading-normal flex size-10 items-center justify-center text-[#111813] rounded-full"
                    href="#"
                  >
                    2
                  </a>
                  ...
                  <span className="text-sm font-normal leading-normal flex size-10 items-center justify-center text-[#111813] rounded-full">
                    ...
                  </span>
                  <a
                    className="flex size-10 items-center justify-center"
